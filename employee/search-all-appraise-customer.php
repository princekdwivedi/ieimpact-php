<?php
	...
	if(isset($_SESSION['employeeId'])){
		...
		$query	=	"SELECT firstName,lastName FROM members WHERE memberType='".CUSTOMERS."' AND (firstName LIKE '%$searchName%' OR lastName LIKE '%$searchName%') AND appraisalSoftwareType=4";

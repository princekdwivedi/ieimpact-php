<?php
	...
	$employeeOwnTestScore  =	$employeeObj->getSingleQueryResult("SELECT testScore FROM employee_details WHERE employeeId=$s_employeeId","testScore");
	...
	<table width="98%" align="center" border="0" cellpadding="2" cellspacing="2" style="border:2px solid #bebebe">		
		<tr>			
			<td valign="top"  colspan="2" class="textstyle3">
				...
				<b>Your Score: <?php echo $employeeOwnTestScore;?></b>
			</td>
		</tr>
		<tr>
			<td height="5"></td>

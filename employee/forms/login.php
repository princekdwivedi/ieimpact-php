...
<tr>
	...
	<tr>
		...
		<tr>
			<td class="formlink1">Login ID</td>
			<td><B>:</B></td>
			<td>
				<input type="text" size="3" name="loginId" value="<?php echo $rememberID;?>" class="input" onKeyPress="return checkForNumber();">&nbsp;<font class="smalltext">(Numeric ID)</font>
			</td>
		</tr>
		<tr>
			<td height="10"></td>

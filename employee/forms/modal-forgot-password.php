...
<div class="modal-overlay" id="forgotPasswordModal">
	<div class="modal-container">
		...
		<div class="modal-body">
			<div id="forgotPasswordError" class="modal-error-message" style="display: none;"></div>
			<div id="forgotPasswordSuccess" class="modal-success-message" style="display: none;"></div>
			<div class="modal-loading" id="forgotPasswordLoading">
			...
			<form id="forgotPasswordForm" onsubmit="return submitForgotPassword(event);">
				<div class="modal-form-group">
					...
					<input type="email" id="forgotPasswordEmail" name="email" value="<?php echo isset($email) ? htmlspecialchars($email) : '';?>" placeholder="Enter your registered email address" maxlength="100" required>
				</div>
				
				<div class="modal-button-group">
					<button type="submit" class="modal-btn modal-btn-primary" id="forgotPasswordSubmit">Submit</button>
					<button type="button" class="modal-btn modal-btn-secondary" onclick="closeForgotPasswordModal()">Cancel</button>
				</div>
...
function submitForgotPassword(event) {
	...
	var loadingDiv = document.getElementById('forgotPasswordLoading');
	...
	xhr.open('POST', '<?php echo SITE_URL_EMPLOYEES;?>/forgot-password.php', true);

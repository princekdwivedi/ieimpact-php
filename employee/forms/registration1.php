		...
		<table width="100%" cellpadding="3" cellspacing="2" border="0" >
			...
			<tr>
				...
				<td class="smalltext2" valign="top">
					+91-<input type="text" name="mobile" value="<?php echo $mobile;?>" class="textbox2" maxlength="10" size="36" onKeyPress="return checkForNumber();"><br />[We will send SMS messages on this number.]
				</td>
			</tr>
			<tr>
				<td colspan="3">

...
<html>
<title>
	Employees Assign For <?php echo $title;?> To <?php echo $customersName;?>
</title>
...
<center>
	<table width="98%" align="center" border="0" cellpadding="2" cellspacing="2">
		<tr>
			<td colspan="4" class="smalltext2"><b>Employees Assign For <?php echo $title;?> To <?php echo $customersName;?></b></td>
		</tr>
		<tr>
	...
	<?php
		$query	=	"SELECT pdf_clients_employees.employeeId,hasReplyAccess,hasQaAccess,firstName,lastName FROM pdf_clients_employees INNER JOIN employee_details ON pdf_clients_employees.employeeId=employee_details.employeeId WHERE customerId=$customersId";

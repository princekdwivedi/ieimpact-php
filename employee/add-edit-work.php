...
function checkValidWork()
{
	...
	if(form1.transcriptionLinesEntered.value	==	"" && form1.vreLinesEntered.value	==	"" && form1.qaLinesEntered.value	==	"")
	{
		alert("Please Enter Lines !!");
		form1.transcriptionLinesEntered.focus();
		return false;
	}
}
...
<table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" valign="top">
	...
	<?php 
		if(!empty($errorMsg))
		{
			echo "<tr><td><font size='3' color='red'>$errorMsg</td></tr>";
		}
	...
	<tr>
		...
		<td>
			<?php
				$url2	=	SITE_URL_EMPLOYEES. "/change-customer.php?platform=";
			?>
	...
	<tr>
		<td class="title">Transcription (SINGLE)</td>
		<td class="title">:</td>
		<td class="smalltext2">
			<input type="checkbox" name="transcriptionDirect" value="1" <?php echo $transcriptionDirectCheck;?>><b>Direct</b>&nbsp;&nbsp;
			...
			&nbsp;&nbsp;
			<input type="checkbox" name="transcriptionIndirect" value="1" <?php echo $transcriptionIndirectCheck;?>><b>Indirect</b>&nbsp;&nbsp;
	...
	<tr>
		...
		<td class="title">:</td>
		<td class="smalltext2">
			<input type="checkbox" name="vreDirect" value="1" <?php echo $vreDirectCheck;?>><b>Direct</b>&nbsp;&nbsp;
			...
			<input type="checkbox" name="vreIndirect" value="1" <?php echo $vreIndirectCheck;?>><b>Indirect</b>&nbsp;&nbsp;
	...
	<tr>
		...
		<td class="title">:</td>
		<td class="smalltext2">
			<input type="checkbox" name="qaDirect" value="1" <?php echo $qaDirectCheck;?>><b>Direct</b>&nbsp;&nbsp;
			<input type="text" name="qaLinesEntered" value="<?php echo $qaLinesEntered;?>" size="10" maxlength="20" onKeyPress="return checkForNumber();">&nbsp;&nbsp;
			<input type="checkbox" name="qaIndirect" value="1" <?php echo $qaIndirectCheck;?>><b>Indirect</b>&nbsp;&nbsp;
	...
	<tr>
		...
		<td class="title">:</td>
		<td>
			<input type="text" name="workedOn" value="<?php echo $workedOn;?>" size="10" readonly>
		</td>
	</tr>
	<tr>
		<td align='center' colspan="3">&nbsp;</td>

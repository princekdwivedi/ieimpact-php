<?php
	...
	$a_newDepartment=	array("1"=>"MT");
	$month			=	date("m");
	$year			=	date("Y");
	$andClause		=	"";
	$andClause1		=	"";
	$andClause2		=	"";
	$employeeName	=	" AND departmentId=1";
	$departmentId	=   0;
	$display		=	"";
	$display1		=	"none";
	$display2		=	"none";
...
function openViewSalaryWidow(employeeId,month,year,departmentId,salaryId)
{
	path = "<?php echo SITE_URL_EMPLOYEES?>/view-salary-given.php?employeeId="+employeeId+"&month="+month+"&year="+year+"&departmentId="+departmentId+"&salaryId="+salaryId;
		...
		<?php
			if(!empty($totalMoney))
			{
				...
				elseif(!empty($salaryId))
				{
					...
					echo "<a href='javascript:openViewSalaryWidow($employeeId,$month,$year,$departmentId,$salaryId)' class='link_style12'>View</a>";
				}
			}
		?>
	</td>
...
<?php
	...
	echo "</font></td></tr><tr height=20><td align=center><b>Total Records : " . $totalRecords . "</b></font></td></tr></table></td></tr>";

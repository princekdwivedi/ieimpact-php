...
<?php
	...
	if($result	=	$orderObj->getOrderDetails($orderId,$customerId))
	{
		...
		$isStoredOrderInAmazon			=	$row['isStoredOrderInAmazon'];
		$isStoredPublicRecordInAmazon	=	$row['isStoredPublicRecordInAmazon'];
		$isStoredMlsFileInAmazon		=	$row['isStoredMlsFileInAmazon'];	
		$isStoredMarketConditionInAmazon=	$row['isStoredMarketConditionInAmazon'];
		$isStoredOtherFileInAmazon		=	$row['isStoredOtherFileInAmazon'];
...
<table width='98%' align='center' cellpadding='3' cellspacing='3' border='0'>
	<tr>
		<td colspan="10" align="center">
			<?php
				$nextPreviousCenter	=	"align='center'";
...
<fieldset style="border:1px solid #333333">
	...
	<label>
		<table width="100%" align="center" border="0" cellpadding="2" cellspacing="2">
			<tr>
				<td width="11%" class="smalltext2">ORDER NO</td>
				...
				<td width="12%" class="smalltext2">CUSTOMER ORDER#</td>
				<td width="1%" class="smalltext2">:</td>
				<td width="15%" class="smalltext14">
					<?php echo $orderId;//$employeeDisplayOrderID;?>
				</td>
			...
			<tr>
				...
				<td class="smalltext2" valign="top">ORDER DATE</td>
				<td class="smalltext2" valign="top">:</td>
				<td class="smalltext14" valign="top">
				...
				<td valign="top" class='smalltext2'>
						...
						<?php 
							echo "($customerId)<font size='3'><b> <a href='".SITE_URL_EMPLOYEES."/new-pdf-work.php?isSubmitAdvancedSearch=1&serachCustomerId=$customerId' class='$customerLinkStyle'>".ucwords($customerName)."</a><font class='$customerLinkStyle'>".$customerOrderText."</font></a>";
						...
						?></b></font>
						<br>
						<a href="<?php echo SITE_URL_EMPLOYEES;?>/new-pdf-work.php?isSubmitAdvancedSearch=1&serachCustomerId=<?php echo $customerId?>" class="link_style12">Click here to view all orders of this customer</a>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="smalltext2">ORDER ID</td>
				<td class="smalltext2">:</td>
				<td class="smalltext14">
					<?php echo $orderId;?>
				</td>
						...
						<table width="100%" cellpadding="3" cellspacing="3" border="0">
								...
								<td valign="top" class="smalltext2">
									<?php 
										if($hasOrderFile)
										{
											...
											echo "<a href='".SITE_URL_EMPLOYEES."/employee-amazon-download.php?ID=$orderId&t=OF&f=N' class='link_style2'>".$orderFileName.".".$orderFileExt."</a>";
								...
								<td valign="top" class="smalltext2">
									<?php 
										if($hasPublicRecordFile)
										{
											...
											echo "<a href='".SITE_URL_EMPLOYEES."/employee-amazon-download.php?ID=$orderId&t=PF&f=N' class='link_style2'>".$publicRecordFileName.".".$publicRecordFileExt."</a>";
								...
								<td valign="top" class="smalltext2">
									<?php 
										if($hasMlsFile)
										{
											...
											echo "<a href='".SITE_URL_EMPLOYEES."/employee-amazon-download.php?ID=$orderId&t=MF&f=N' class='link_style2'>".$mlsFileName.".".$mlsFileExt."</a>";
								...
								<td valign="top" class="smalltext2">
									<?php 
										if($hasMarketConditionFile)
										{
											...
											echo "<a href='".SITE_URL_EMPLOYEES."/employee-amazon-download.php?ID=$orderId&t=CF&f=N' class='link_style2'>".$marketConditionFileName.".".$marketConditionExt."</a>";
								...
								<td valign="top" class="smalltext2">
									<?php 
										if($hasOtherFile)
										{
											...
											echo "<a href='".SITE_URL_EMPLOYEES."/employee-amazon-download.php?ID=$orderId&t=OTF&f=N' class='link_style2'>".$otherFileName.".".$otherFileExt."</a>";
							...
							<?php
									while($row		=	mysql_fetch_assoc($result))
									{
										...
										echo "<a href='".SITE_URL_EMPLOYEES."/other-download-amazon.php?ID=$otherId&t=OT' class='link_style2'><b>".$fileName.".".$fileExtension."</b></a>";
...
<fieldset style="border:1px solid #333333">
	<legend class="heading3"><b>CUSTOMER INSTRUCTIONS</b></legend>
	<label>
		<table width="100%" align="center" border="0" cellpadding="2" cellspacing="2">
			<tr>
				<td colspan="3" align="left">
									...
									<table width="100%" cellpadding="3" cellspacing="3" border="0">
										...
										<tr>
											<td colspan="3">
												...
												<div style='width:700px;border:0px solid #ff0000;overflow:auto;height:280px'>
													<table width="100%" cellpadding="3" cellspacing="3" border="0">
														<tr>
															<td class="textstyle">
																<p align="justify">
							...
							<tr>
								<td width="50%" valign="top">
									 <table width="100%" cellpadding="3" cellspacing="3" border="0">
										...
										<tr>
											<td colspan="3">
												<div style='width:450px;border:0px solid #ff0000;overflow:auto;height:180px'>
													<table width="100%" cellpadding="3" cellspacing="3" border="0">
														<tr>
															<td class="textstyle">
																<p align="justify">
										...
										<?php
											...
											{
												echo "<tr><td colspan='3' class='smalltext2' align='center'>No Note Available</td></tr>";
											}
											?>
									</table>
							</td>
					...
					<div id="showHideMessageRatings">
						<table width="100%" cellpadding="3" cellspacing="3" border="0">
							<tr>
								<td width="50%" valign="top">
									<fieldset style="border:1px solid #333333">
										<legend class="heading5">PREVIOUS ORDER MESSAGES FROM - <?php echo $customerName;?></legend>
										<label>
											<table width="100%" align="center" border="0" cellpadding="2" cellspacing="2">
												<?php
												...
												<tr>
													...
													<td width="1%">&nbsp;</td>
													<td class="textstyle" width="14%"><b>Date</b></td>
													<td width="1%">&nbsp;</td>
												...
												<tr>
													<td colspan="6">
														<div style='width:550px;border:0px solid #ff0000;overflow:auto;height:200px'>
															<table width="100%" cellpadding="0" cellspacing="0" border="0">
																<?php
																	...
																	while($messageRow		=	mysql_fetch_assoc($result))
																	{
																		...
																		{
																			$customerMessageImage	=	"<img src='".SITE_URL."/images/blinking-new.gif' title='New Ratings'>";
																		}
																		else
																		{
																...
																<tr>
																	...
																	<td width="1%">&nbsp;</td>
																	<td class="textstyle" valign="top" width="14%"><?php echo showDate($messageDate);?></td>
																	<td width="1%">&nbsp;</td>
												...
												{
													echo "<tr><td colspan='3' class='smalltext2' align='center'>No Message Available</td></tr>";
												}
											?>
											</table>
										</label>
								...
								<td valign="top">
									<fieldset style="border:1px solid #333333">
										<legend class="heading5">RATINGS BY <?php echo $customerName;?> IN 10 PREVIOUS ORDERS</legend>
										<label>
											<table width="100%" align="center" border="0" cellpadding="2" cellspacing="2">
											<?php
											...
											<tr>
												<td colspan="8">
													<div style='width:530px;border:0px solid #ff0000;overflow:auto;height:200px'>
														<table width="100%" cellpadding="0" cellspacing="0" border="0">
															<?php
															...
															?>
															<tr>
																<td class="smalltext" valign="top" width="3%"><?php echo $customerRatingCount;?>)</td>
																<td class="textstyle" valign="top" width="31%">
																...
																<td width="1%">&nbsp;</td>
																<td class="textstyle" valign="top" width="22%">
																	<?php
																...
																<td width="1%">&nbsp;</td>
																<td class="smalltext2" valign="top" width="17%">
					...
					<div id="showHideEmployeeMessageRatings">
						<table width="100%" cellpadding="3" cellspacing="3" border="0">
							<tr>
								<td width="50%" valign="top">
									<fieldset style="border:1px solid #333333">
										<legend class="heading5">PREVIOUS EMPLOYEE MESSAGES FOR ORDERS - <?php echo $customerName;?></legend>
										<label>
											<table width="100%" align="center" border="0" cellpadding="2" cellspacing="2">
												<?php
								...
								<td valign="top">
									<fieldset style="border:1px solid #333333">
										<legend class="heading5">ACCEPTED EMPLOYEES PREVIOUS ORDER RATINGS FROM QA</legend>
										<label>
											<table width="100%" align="center" border="0" cellpadding="2" cellspacing="2">
											<?php

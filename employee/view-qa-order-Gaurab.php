...
<?php
	...
	if(isset($_REQUEST['formSubmitted']))
	{
		...
		{	
			...
			{
				$freeEmailSub	=	 "Free order competed:".$customerName." - ".$orderAddress;
						...
						$content =
							...
							if ("Ok"        ==    $parsedresponse->messages->resultCode) {
								if (isset($parsedresponse->directResponse)) {
									...
									{
										$is_marked_as_postpaid	=	true;	
										$cardAccountErrorMsg	=	"Fail to get desired response code.&nbsp;&nbsp;(KASE II)";
									}
								}
								else
								{								
									$is_marked_as_postpaid	=	true;
									$cardAccountErrorMsg	=	"Fail to get transactions ID.&nbsp;&nbsp;(KASE III)";
								}
							}
							else
							{
			...
			if($result			=	$orderObj->getOrderDetails($orderId,$customerId))
			{
				...
				{
					if($isChangedPrice	==	0 && $isPaidThroughWallet == "no")
					{
				...
				if($hasReceiveEmails		 == 0)
				{
					...
					$trackEmailOrderNo		 =	"Completed your order No - ".str_replace(",","",$orderAddress);
				...
				{
					$a_managerEmails	    =	str_replace(',john@ieimpact.net','',$a_managerEmails);
		...
		<table width='100%' align='center' cellpadding='0' cellspacing='0' border='0'>
			...
			<tr>
				...
				<td valign="top">
					...
					&nbsp;&nbsp;
					<input type="radio" name="readChecklist[<?php echo $countChecklist;?>]" value="1|<?php echo $checklistId;?>"  onclick="return isValidCheckAnswer(1,<?php echo $checkAnswer;?>)">Yes
					&nbsp;&nbsp;
					<input type="radio" name="readChecklist[<?php echo $countChecklist;?>]" value="2|<?php echo $checklistId;?>"  onclick="return isValidCheckAnswer(2,<?php echo $checkAnswer;?>)">No
					&nbsp;&nbsp;
					<input type="radio" name="readChecklist[<?php echo $countChecklist;?>]" value="3|<?php echo $checklistId;?>">N/A
				</td>
			</tr>
			<?php
				}
